...
FEATURE_LAYER_URL = "https://services-eu1.arcgis.com/PB4bGIQ2JEvZVdru/arcgis/rest/services/CD16_V2_Fusion_Sens/FeatureServer/9"

# PostgreSQL/PostGIS connection parameters
PG_HOST = "localhost"
PG_PORT = 5433
PG_DATABASE = "rcp_cd16"
PG_USER = "diagway"
PG_PASSWORD = "diagway"
...
SQL_QUERY = """  
	select id,cumuld,cumulf,prd,abd,prf,abf,axe,nom_agence,categorie,note_num,note_classe,largeur,longueur,ST_AsEWKB(ST_Transform(geom, 4326)) as geom,filename 
